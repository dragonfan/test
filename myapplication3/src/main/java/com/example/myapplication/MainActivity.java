...
import com.example.myapplication.fragment.NewsFatherFragment;
...
public class MainActivity extends Activity {
    ...
    private View.OnClickListener newsOnClickListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            FragmentTransaction replace = ft.replace(R.id.fl_content, newsFatherFragment, MainActivity.TAG);
            ft.commit();
            setButton(v);
